<div class="panel panel-default">
					<div class="panel panel-heading" style="background-color:#284761; color:#fff;">
						  &nbsp;<strong><h4  align="center"> Our Categories</h4></strong>
					</div>
				...
				while($rows=mysqli_fetch_array($select1)){
									...
									$sel_T11=$db->query($sel_photo);
										...
										$rows_p1=mysqli_fetch_array($sel_T11);		
													...
													{
													$photo="<img src='../forum/admin/".$rows_p1['photo']."'  style='margin-top:3%;' class='img-circle' alt='Cinque Terre' width='60px' height='60px'>							"	;
													}else{
													
													$photo="<img src='dummy.jpg'  style='margin-top:5%;' class='img-circle' alt='Cinque Terre' width='60px' height='60px'>								";
													}
				...
				echo  "  <div class='col-md-12'>
												...
												<div class='panel panel-default' style=' margin-top:20px; margin-bottom:0px;'>	
														...
														<div class='col-md-4'>
																...
																<h4 class='text-primary' style='padding:10px;padding-left:20px;'>
